...
def test_pressure_converter():
    ...
    from_unit = input("Введите исходную единицу измерения (например, atm, Pa, PSI): ")

    # Получаем словарь units из функции pressure_converter
    units = {
        "Pa": 1,
        "kiloPa": 1000,
        "MegaPa": 1000000,
    ...
    excel_creater(value, from_unit, sorted_units, "pressure")




def excel_creater(value, from_unit, to_units, type):
    ...
    for to_unit in to_units:
        try:
            converted_value = pressure_converter(value, from_unit, to_unit)
